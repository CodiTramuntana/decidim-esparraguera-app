...
ActiveRecord::Schema.define(version: 20190130095821) do
  ...
  create_table "decidim_proposals_collaborative_draft_collaborator_requests", id: :bigint, default: -> { "nextval('decidim_proposals_collaborative_draft_collaborator_reque_id_seq'::regclass)" }, force: :cascade do |t|
